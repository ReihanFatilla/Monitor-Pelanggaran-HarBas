...
<a href="/dashboard" class="nav_link"> 
    <i class='bx bxs-dashboard nav_icon {{ Request::is("dashboard") ? "active" : "" }}'></i> 
...
<a href="/kategori" class="nav_link"> 
    <i class='bx bxs-category-alt nav_icon {{ Request::is("kategori") ? "active" : "" }}' size='lg'></i> 
    <span class="nav_name">Pelanggaran</span> 
</a>

<a href="/pelanggaran" class="nav_link"> 
    <i class='bx bx-receipt nav_icon {{ Request::is("pelanggaran") ? "active" : "" }}' size='lg'></i> 
...
<a href="/input-pelanggaran" class="nav_link"> 
    <i class='bx bx-check-circle nav_icon {{ Request::is("input-pelanggaran") ? "active" : "" }}'></i> 
